...
class LocalPix2StructMetrics:
    @staticmethod
    def anls_metric(prediction: str, target: str, theta: float = 0.5) -> float:
        ...
        if normalized_dist >= theta:
            return 0.0
        
        return 1.0 - normalized_dist

pix2struct_metrics = LocalPix2StructMetrics()
